...
<body>
    ...
    <div class="row me-0">
        ...
        <div class="col-md-6">
            <div class="login-form">
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        <select name="clase" class="form-control text-center bg-light" required="required">
        ...
        <div class="col-md-5 center-block cajawapa bg-success" style="display: none;">
            ...
            <span class="ms-5"><b>¡El mítico ahorcado... en andaluz!</b></span> <br> <br>
    ...
    <script>
            // Script para que aparezca las instrucciones por un lateral
